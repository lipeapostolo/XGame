    ...
    public class ControllerBase : ApiController
    {
        ...
        public async Task<HttpResponseMessage> ResponseAsync(object result, IServiceBase serviceBase)
        {
            ...
            if (!serviceBase.Notifications.Any())
            {
                ...
                {
                    //Mostra o erro
                    return Request.CreateResponse(HttpStatusCode.Conflict, $"Houve um problema interno com o servidor.Entre em contato co a Administração");
                }
            }
            else
            {
        ...
        public async Task<HttpResponseMessage> ResponseExeptionAsync(Exception ex)
        {
